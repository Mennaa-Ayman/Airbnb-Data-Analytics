...
plot_files = {
    ...
    "Price by Proximity to Landmarks": "price_by_proximity.png",
    "Price by Listing Tier": "price_by_listing_tier.png",
    "Price by Room Type": "price_by_guest.png",
    "Price by view Type": "price_by_view_type.png"
